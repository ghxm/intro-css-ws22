...
Lucky for us, programmers and researchers also often have no idea what they're doing. This is where online forums come into play, specifically *Stack Overflow*.
...
The `tidyverse` offers five main operations to work with your data: `mutate()`, `select()`, `filter()`, `summarise()` and `arrange()`. We will explore each of them in detail below:
