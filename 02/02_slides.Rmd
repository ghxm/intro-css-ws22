...
1. Quick recap and overview
2. Data types, collection and storage
3. Research design in CSS
4. Reproducibility
5. Term papers
...
# Recap: What is Computational Social Science?
...
@TODO see assigned reading paper
...
- Surveys
- Measure / Annotate (potentially crowdsourced) @TOOD book crowsourced, github overview dings
- *APIs*
- *Webscraping*
...
# Finished datasets available for usage
...
@TOOD use examples form syllabus form above, corpus, relational database, simeple dataset etcetc
...
@TODO https://www.bitbybitbook.com/en/1st-ed/ethics/
